...
- (void)commonInit
{
   ...
   // self.textField = [[UITextField alloc]initWithFrame:CGRectMake(0, 0, 250, 21.0)];
    
   // self.navigationItem.titleView = self.textField;
    //[self.textField addTarget:self action:@selector(loadAddress:event:) forControlEvents:UIControlEventEditingDidEndOnExit];
