...
extern NSString *const kESActivityBlockKey;
...
extern NSString *const kESActivityTypeShare;//     = @"share";
...
// Field keys
extern NSString *const kESPhotoPictureid;//          =@"objectId";
...
extern NSString *const kESPhotoPermission;//         = @"permission";
...
#pragma mark - user sharing  Attributes

#pragma mark - PFObject Activity Class
// Class key
extern NSString *const kSideToneClassKey;

// Field keys
extern NSString *const kSideToneUserKey;
extern NSString *const kSideTonePhotoIdKey;
extern NSString *const kSideToneCGRectKey;
extern NSString *const kSideToneAudioKey;
extern NSString *const kSideTonePinKey;//                =@"pin";
extern NSString *const kSideToneFrameKey;//                =@"pin";
