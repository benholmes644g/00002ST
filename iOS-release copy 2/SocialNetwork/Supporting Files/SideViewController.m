...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 2) {
            ...
            [avatarImageView setImage:[UIImage imageNamed:@"IconMsg"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
        }
        ...
        if (indexPath.row == 3) {
            ...
            UIImageView *avatarImageView = [[UIImageView alloc] init];
            avatarImageView.frame = CGRectMake( 12.0f, 10.0f, 20.0f, 20.0f);
            [avatarImageView setImage:[UIImage imageNamed:@"IconProfile1"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 2) {
            //[self postNotificationWithString:@"FindFriendsOpen"];
            [self postNotificationWithString:@"ChatOpen"];

        }
        if (indexPath.row == 3) {
            //[self postNotificationWithString:@"FindFriendsOpen"];
            [self postNotificationWithString:@"ProfileOpen_"];
