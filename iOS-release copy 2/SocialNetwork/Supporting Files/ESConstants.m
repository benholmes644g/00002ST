...
NSString *const kESChatFirebaseCredentialKey  =  @"https://sidetones.firebaseIO.com";
...
NSString *const kESActivityBlockKey                       = @"block";
...
NSString *const kESActivityTypeShare     = @"share";
...
NSString *const kESChatInviteUserMessage                       = @"";
...
// Field keys
NSString *const kESPhotoPictureid          =@"objectId";
...
NSString *const kESPhotoPermission         = @"permission";
...
// Class key
 NSString *const kSideToneClassKey                =@"sidetones";
...
// Field keys
 ...
 NSString *const kSideTonePinKey                =@"pin";
 NSString *const kSideToneFrameKey                =@"frame";