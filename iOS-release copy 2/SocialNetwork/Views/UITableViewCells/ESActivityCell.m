...
- (void)setActivity:(PFObject *)activity {
    ...
    NSString *activityString = [ESActivityFeedViewController stringForActivityType:(NSString*)[activity objectForKey:kESActivityTypeKey] type:self.sender];
    if(self.sender)
    {
        self.user = [activity objectForKey:kESActivityToUserKey];
