 ...
 */
@interface ESPhotoDetailsViewController : PFQueryTableViewController <UITextFieldDelegate, UIActionSheetDelegate, ESPhotoDetailsHeaderViewDelegate, ESBaseTextCellDelegate,AVAudioPlayerDelegate,UIGestureRecognizerDelegate,IQAudioRecorderControllerDelegate,UIScrollViewDelegate>
{
    /**
    ...
    NSMutableArray *audioMarkerArray;
...
@property (nonatomic)BOOL disablePin;
...
@property (nonatomic,retain)NSMutableArray *addedAudiosData; // contains array of markers
