 ...
 */
@interface ESShareWithFollowersViewController : PFQueryTableViewController <ESFindFriendsCellDelegate, ABPeoplePickerNavigationControllerDelegate, MFMailComposeViewControllerDelegate, MFMessageComposeViewControllerDelegate, UIActionSheetDelegate,UISearchDisplayDelegate, UISearchBarDelegate>
...
@property (nonatomic, retain) NSMutableArray * objectsData;
...
@property (nonatomic, strong) NSString *sharedStats;
...
/**
 *  Invite friends to join the Sidetone.
 */
