...
@interface ESMessengerView : JSQMessagesViewController <UIActionSheetDelegate, UIImagePickerControllerDelegate, IQAudioRecorderControllerDelegate,JSImagePickerViewControllerDelegate>
