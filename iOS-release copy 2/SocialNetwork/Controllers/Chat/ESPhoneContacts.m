                ...
                if (ABAddressBookGetAuthorizationStatus() == kABAuthorizationStatusAuthorized) {
                    ...
                    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
                        if (error == nil)
                        {
                            ...
                            temp=[users1 sortedArrayUsingDescriptors:@[sort]];
                          //  temp1=[users2 sortedArrayUsingDescriptors:@[sort]];
                            [users1 removeAllObjects];
                           // [users2 removeAllObjects];
                            users1 = [NSMutableArray arrayWithArray:temp];
                            //users2 = [NSMutableArray arrayWithArray:temp1];
