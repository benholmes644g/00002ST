 ...
 */
//@class STParseHelper;
@interface ESActivityFeedViewController : PFQueryTableViewController <ESActivityCellDelegate,UINavigationControllerDelegate>{

    BOOL bgjob;
    BOOL enableCustomPullToRefresh;
...
@property (nonatomic, strong) NSMutableArray *dataset , *dataset_;
